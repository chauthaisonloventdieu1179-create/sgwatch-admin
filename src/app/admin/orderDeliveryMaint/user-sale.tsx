...
import Table from "@/components/table/table.orderDeliveryAndMaintenance.orderingInformation";
...
const UserSale = () => {
  ...
  return (
    <div className="w-full  border rounded-[8px] bg-white flex flex-col">
