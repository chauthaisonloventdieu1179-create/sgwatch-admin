...
import { IBrandDetailResponse } from "@/types/admin/brand";
...
const Create = ({ id }: { id?: string }) => {
  ...
  const fetchDetail = async () => {
    ...
    try {
      const response = await sendRequest<IBrandDetailResponse>({
        url: `/admin/shop-brands/${id}`,
        method: "GET",
        headers: {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const url = id
        ? `${NEXT_PUBLIC_API_URL}/admin/shop-brands/${id}`
        : `${NEXT_PUBLIC_API_URL}/admin/shop-brands`;
      ...
      message.success(id ? "Cập nhật thương hiệu thành công" : "Tạo thương hiệu thành công");
        ...
        >
          <div className="w-full h-full px-[16px] flex flex-col justify-start items-center">
            <div className="pb-[8px] pt-[5px] w-full border-b-[2px] border-[#C8C8C8] text-[#212222] text-[14px] font-medium">
              {id ? "Chỉnh sửa thương hiệu" : "Tạo thương hiệu mới"}
              <span className="text-[12px] pl-[10px] font-[400] text-[#9E9E9E]">
                {id ? "Chỉnh sửa thông tin thương hiệu." : "Nhập thông tin thương hiệu mới."}
              </span>
            </div>
                ...
                <div className="w-[75%] flex flex-col justify-start items-start gap-[20px]">
                  ...
                  <div className="w-full">
                    ...
                    <Input
                      ...
                      placeholder="Nhập slug (vd: casio)"
                      className={`${
