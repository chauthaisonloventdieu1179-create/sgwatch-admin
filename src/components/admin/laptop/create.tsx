              ...
              <div className="w-full flex px-[150px] justify-start items-start">
                ...
                <div className="w-[80%] flex flex-col justify-start items-start gap-[20px]">
                  ...
                  <div className="w-full">
                    ...
                    <div className="mt-[10px]">
                      <label htmlFor="laptop-images" className="w-[130px] h-[32px] bg-[#212222] cursor-pointer rounded-[10px] text-white font-medium text-[12px] flex justify-center items-center gap-[5px] hover:scale-105 transition-all duration-200">
                        <Image src="/epack/icon_plus.svg" alt="" width={10} height={6} style={{ objectFit: "cover" }} />
                        Chọn hình ảnh
                      </label>
                      <input id="laptop-images" type="file" accept="image/*" multiple onClick={(e) => { (e.target as HTMLInputElement).value = ""; }} onChange={handleImageChange} style={{ display: "none" }} />
                    </div>
                  </div>
                </div>
              </div>
