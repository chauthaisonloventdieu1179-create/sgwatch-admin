...
const Create = ({
  ...
  const [attrGpu, setAttrGpu] = useState<string>("");
  const [attrPorts, setAttrPorts] = useState<string>("");
    ...
    if (id) {
      const fetchProduct = async () => {
        ...
        try {
          ...
          setAttrGpu(p.attributes?.gpu || "");
          setAttrPorts(p.attributes?.ports || "");
          setAttrTargetCustomer(p.attributes?.target_customer || "");
          setAttrDesign(p.attributes?.design || "");
  ...
  const handleSubmit = async () => {
    ...
    if (attrGpu) formData.append("attributes[gpu]", attrGpu);
    if (attrDesign) formData.append("attributes[design]", attrDesign);
    if (attrPorts) formData.append("attributes[ports]", attrPorts);
    if (attrTargetCustomer) formData.append("attributes[target_customer]", attrTargetCustomer);
    if (attrBattery) {
            ...
            <div className="w-full flex justify-center items-start mt-[40px] pb-[100px]">
              <div className="w-full flex px-[150px] justify-start items-start">
                ...
                <div className="w-[80%] flex flex-col justify-start items-start gap-[20px]">
                  ...
                  <div className="w-full">
                    <label className="text-[14px] font-[400] text-[#000000]">Danh mục</label>
                    <Select allowClear placeholder="Chọn danh mục" className="h-[32px] w-full mt-[8px]" value={categoryId} onChange={(value) => setCategoryId(value)} options={categoryOptions} disabled={!!defaultCategoryId} />
                  </div>
                  <div className="w-full">
                    <label className="text-[14px] font-[400] text-[#000000]">Mô tả ngắn</label>
                    <TextArea value={shortDescription} onChange={(e) => setShortDescription(e.target.value)} placeholder="Nhập mô tả ngắn" rows={2} className="w-full text-[14px] mt-[8px] font-[400] text-[#212222] placeholder:text-[#9E9E9E]" />
                  </div>
                  <div className="w-full">
                    <label className="text-[14px] font-[400] text-[#000000]">Mô tả chi tiết</label>
                    <TextArea value={description} onChange={(e) => setDescription(e.target.value)} placeholder="Nhập mô tả chi tiết" rows={4} className="w-full text-[14px] mt-[8px] font-[400] text-[#212222] placeholder:text-[#9E9E9E]" />
                  </div>
                  ...
                  <div className="w-full flex gap-[20px]">
                    ...
                    <div className="w-[25%]">
                      <label className="text-[14px] font-[400] text-[#000000]">Loại hàng</label>
                      <Select allowClear placeholder="Chọn loại hàng" className="h-[32px] w-full mt-[8px]" value={isDomestic} onChange={(value) => setIsDomestic(value)} options={DOMESTIC_OPTIONS} />
                    </div>
                    <div className="w-[25%]">
                      <label className="text-[14px] font-[400] text-[#000000]">Tình trạng</label>
                      <Select allowClear placeholder="Chọn tình trạng" className="h-[32px] w-full mt-[8px]" value={isNew} onChange={(value) => setIsNew(value)} options={[{ value: "1", label: "Hàng mới" }, { value: "0", label: "Hàng cũ" }]} />
                    </div>
                  </div>
                  <div className="w-full">
                  ...
                  <div className="w-full flex gap-[20px]">
                    <div className="w-[50%]">
                      <label className="text-[14px] font-[400] text-[#000000]">GPU</label>
                      <Input value={attrGpu} onChange={(e) => setAttrGpu(e.target.value)} placeholder="Nhập thông tin GPU" className="h-[32px] w-full text-[14px] mt-[8px] font-[400] text-[#212222] placeholder:text-[#9E9E9E]" />
                    </div>
                    <div className="w-[50%]">
                      <label className="text-[14px] font-[400] text-[#000000]">Thiết kế / Trọng lượng</label>
                      <Input value={attrDesign} onChange={(e) => setAttrDesign(e.target.value)} placeholder="Nhập thiết kế / trọng lượng" className="h-[32px] w-full text-[14px] mt-[8px] font-[400] text-[#212222] placeholder:text-[#9E9E9E]" />
                    </div>
                  </div>
                  <div className="w-full flex gap-[20px]">
                    <div className="w-[50%]">
                  ...
                  <div className="w-full">
                    <label className="text-[14px] font-[400] text-[#000000]">Cổng kết nối</label>
                    <TextArea value={attrPorts} onChange={(e) => setAttrPorts(e.target.value)} placeholder="Nhập thông tin cổng kết nối" rows={3} className="w-full text-[14px] mt-[8px] font-[400] text-[#212222] placeholder:text-[#9E9E9E]" />
                  </div>
                  <div className="w-full">
                  ...
                  <div className="w-full">
                    ...
                    {!primaryImage && !existingPrimaryImage && (
                      <div className="mt-[10px]">
                        <label htmlFor="macbook-primary-image" className="w-[130px] h-[32px] bg-[#1572FF] cursor-pointer rounded-[10px] text-white font-medium text-[12px] flex justify-center items-center gap-[5px] hover:scale-105 transition-all duration-200">
                          <Image src="/epack/icon_plus.svg" alt="" width={10} height={6} style={{ objectFit: "cover" }} />
                          Chọn ảnh đại diện
                        </label>
                        <input id="macbook-primary-image" type="file" accept="image/*" onClick={(e) => { (e.target as HTMLInputElement).value = ""; }} onChange={handlePrimaryImageChange} style={{ display: "none" }} />
                      </div>
                    )}
                  </div>
                  <div className="w-full">
                    ...
                    <div className="mt-[10px]">
                      <label htmlFor="macbook-images" className="w-[130px] h-[32px] bg-[#212222] cursor-pointer rounded-[10px] text-white font-medium text-[12px] flex justify-center items-center gap-[5px] hover:scale-105 transition-all duration-200">
                        <Image src="/epack/icon_plus.svg" alt="" width={10} height={6} style={{ objectFit: "cover" }} />
                        Chọn hình ảnh
                      </label>
                      <input id="macbook-images" type="file" accept="image/*" multiple onClick={(e) => { (e.target as HTMLInputElement).value = ""; }} onChange={handleImageChange} style={{ display: "none" }} />
                    </div>
                  </div>
                </div>
              </div>
